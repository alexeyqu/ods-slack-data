...
if __name__ == '__main__':
    ...
    users_parser.parse_users(session, '../data/users.json')
    msg_parser.parse_messages(session, '../data')
    reaction_parser.parse_reactions(session, '../data')
    reaction_parser.parse_reactions_count(session, '../data')
